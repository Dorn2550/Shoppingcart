                        ...
                        <table class="table table-bordered border-info">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a role="button" href="<?php echo $base_url; ?>/index.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-dark"><i class="fa-solid fa-pen-to-square me-1"></i>Edit</a>
                                        <a onclick="return confirm('Are you sure you want to delete?')" role="button" href="<?php echo $base_url; ?>/product.delete.php?id=<?php echo $product['id']; ?>" class="btn btn-outline-danger"><i class="fa-solid fa-trash me-1"></i></i>Delete</a>
                                    </td>
                                </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
